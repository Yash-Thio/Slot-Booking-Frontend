...
export function CardDemo(props : any) {
    // console.log(props.data.Image.data[0].attributes.url);
    const backgroundImageUrl = `${process.env.NEXT_PUBLIC_CMS_URL}${props.data.Image.data[0].attributes.url}`;
  return (
