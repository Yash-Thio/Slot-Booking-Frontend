...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] w-screen ml-12 py-44 px-4 overflow-hidden  antialiased relative flex flex-col [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  return (
    <div className=" relative mx-auto py-20 md:py-40 w-full left-0 top-0">
